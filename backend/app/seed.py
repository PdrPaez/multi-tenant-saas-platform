...
from app.models import Membership, Project, Tenant, TenantUsage, User
...
def main():
    ...
    with Session(engine) as db:
        db.execute(text('TRUNCATE request_trace_steps, request_traces, audit_events, tenant_usage, tenant_features, projects, memberships, tenants, users CASCADE'))
